OC.L10N.register(
    ...
    "These groups will be able to impersonate users they are allowed to administrate." : "Эти группы помогут войти в систему под именем другого пользователя для тех пользователей, которые администрируются ими."
},
