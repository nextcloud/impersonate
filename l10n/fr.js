OC.L10N.register(
    "impersonate",
    {
    "An administrator ({actor}) accessed your account" : "Un administrateur ({actor}) a accédé à votre compte",
    ...
    "Logged in as {name} ({uid})" : "Connecté en tant que {name} ({uid})"
},
