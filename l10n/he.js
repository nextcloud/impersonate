OC.L10N.register(
    ...
    "Not enough permissions to impersonate user" : "אין די הרשאות כדי להתחזות למשתמש",
    "Can not impersonate the user because it was never logged in." : "לא ניתן להתחזות למשתמש כיוון שהמשתמש מעולם לא נכנס למערכת.",
    "These groups will be able to impersonate users they are allowed to administrate." : "הקבוצות יוכלו להתחזות למשתמשים שמותר להן לנהל."
},
